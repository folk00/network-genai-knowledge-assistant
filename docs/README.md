...
This folder is written for demos. The goal is to explain the project
clearly without overstating the maturity of the implementation.

## Start Here

1. [demo_walkthrough.md](demo_walkthrough.md)  
   What to show live in a viewers or technical demos.

2. [technical_deep_dive.md](technical_deep_dive.md)  
   How the app, RAG layer and LLM workflows fit together.
